...
// Note (Phase 15.4) : le compteur de mouvements de bulles a été
// déplacé dans la modale d'animation (calculé par millésime côté
// /quadrant/serie-temporelle). Il n'est donc plus calculé ni exposé
// ici — sa lecture n'avait de sens que pendant l'animation des
// transitions, pas sur le quadrant statique d'un seul millésime.
